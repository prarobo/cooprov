...
myOpenrov = openrov()
velocityPub = rospy.Publisher('openrov_joy_vel', Int16, queue_size=10)
...
class joystick():
    ...
    def joyCallback(self,joyInput):
        ...
        if joyInput.buttons[myOpenrov.joyBtnShutdown] == 1:
            ...
            myOpenrov.camMotor.speed = myOpenrov.camMotor.zeroSpeed
            myOpenrov.ledStatus = 0
            
            self.publishVelocity(myOpenrov.starMotor.id, 0, myOpenrov.starMotor.speed)
            self.publishVelocity(myOpenrov.portMotor.id, 0, myOpenrov.portMotor.speed)
            self.publishVelocity(myOpenrov.topMotor.id, 0, myOpenrov.topMotor.speed)
            self.publishVelocity(myOpenrov.camMotor.id, 0, myOpenrov.camMotor.speed)
            self.publishVelocity(myOpenrov.controlID, myOpenrov.ledIndex, myOpenrov.ledStatus)
        ...
        #imu reset
            ...
            self.publishVelocity(myOpenrov.controlID, myOpenrov.imuResetIndex, 0)
        ...
        #pressure sensor reset
            ...
            self.publishVelocity(myOpenrov.controlID, myOpenrov.presResetIndex, 0)
        ...
        #auto depth
            ...
            # Publish auto depth    
            self.publishVelocity(myOpenrov.controlID, myOpenrov.autoDepthIndex, myOpenrov.autoDepth)
        ...
        #auto heading
            ...
            # Publish auto heading    
            self.publishVelocity(myOpenrov.controlID, myOpenrov.autoHeadingIndex, myOpenrov.autoHeading)
    ...
    def publishVelocity(self, mode, submode, value):
	velPub = mode*1000+submode*100+value
	print "velocity: ",velPub
        velocityPub.publish(velPub)
        return        
